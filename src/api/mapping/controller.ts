...
export class mapping {
  ...
  public AddTransactionMapping = async (
    ...
    try {
      ...
      let entity;
      entity = await this.resolver.AddTransactionMappingV1(
        request.payload,
        decodedToken
      );
      if (entity.success) {
  ...
  public transactionMapping = async (
    ...
    try {
      ...
      let entity;
      entity = await this.resolver.transactionMappingV1(
        request.payload,
        decodedToken
      );
      if (entity.success) {
  ...
  public listTokens = async (
    ...
    try {
      ...
      let entity;
      entity = await this.resolver.listTokens(request.payload, decodedToken);
      if (entity.success) {
        return response.response(entity).code(201); // Created
      }
      return response.response(entity).code(200); // Bad Request if failed
